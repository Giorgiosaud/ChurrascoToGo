		    ...
		    ?>
				    <div class="post_header">
				    	<?php
						    ...
						    {
						?>
					    	<div class="post_header_title entry-title title">
							    <h5><?php the_title(); ?></h5>
							    <div class="post_detail date updated">
								    <?php echo get_the_time(THEMEDATEFORMAT); ?>
								    <?php
								    	//Get Post's Categories
								    	$post_categories = wp_get_post_categories($post->ID);
...
<h1 class="title single-title entry-title" style="display:none"><?php the_title(); ?></h1>
<span class="post_date date updated" style="display:none"><?php the_time('j F,Y'); ?></span>
